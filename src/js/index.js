...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initResponsiveSlider('.service-type__slider', '.service-type__slider .swiper-pagination');
    initResponsiveSlider('.service-price__slider', '.service-price__slider .swiper-pagination');
